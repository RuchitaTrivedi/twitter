...
define('CONSUMER_KEY', 'e3JytmjX1TC5YqXHpMPBlSqPl'); // add your app consumer key between single quotes
define('CONSUMER_SECRET', 'psTRkmvB0TSdTjU8YlmmfXuvi960U4mYwvmxy5F2z03HRmmQej'); // add your app consumer secret key between single quotes
define('OAUTH_CALLBACK', 'https://ruchita.000webhostapp.com/public_html/callback.php'); // your app callback URL
